...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2021 at 04:34 PM
...
(7, 1111, 'manu', '14/07/2001', 'Male', 'Mother', '01-10-21', 'images/admin_flowchart.jpg', 'images/university.png', 'images/gantchart.jpg', 'images/level0.jpg', 'images/B_newgasconnection.png', 'none', 'Approved', 1);
...
(11, 1111, 'low delivary', 'images/structur_chart..jpg', 'low delivary is not good for me', 1);
...
(7, 1111, 'images/arvind.pdf', 'ssss', 'Approved', '01-10-2021', 1);
...
(6, 1111, 'Aravindbhavan', '11', '', 'kochi', 'kochi', '852369', 'kochi po', '', 'Ernakulam', '01-10-21', 'house rent resipt', '', 'Approved', 1);
...
--
ALTER TABLE `business_connection`
  MODIFY `business_id` int(30) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `customer_details`
  MODIFY `customer_id` int(200) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1112;
