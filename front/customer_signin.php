...
<!-- <div id="top"> -->	<!-- <a id="homelink"href="index.php"><i id="fa"class="fa fa-home" aria-hidden="true"></i>
 ...
 -->	<div id="container" style="display: flex;">
		<div id="forms" style="flex: 1;">
			...
			<input type="text" placeholder="Username" name="signupname" id="signup_name"><br>
		...
		<div id="image" style="flex: 1;">
         ...
         <a href="customer_login.php" id='loginpage' style="font-size: 14px; color: dodgerblue;text-decoration: none;"><h4  style="font-weight: bold;">I Am Already Member(Login Now)</h4></a>
