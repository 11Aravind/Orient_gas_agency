...
<script>
    function login_erroralert()
{
  swal({
  title: "Mobile Number Or Password Is Incorrect",
  text: "",
  icon: "error",
  button: "OK",
}).then(function(){
...
<div id="myModal" class="modal">
  ...
  <div id="container" style="display: flex;height: 473px;">
    <div id="image" class="image"style="">
      ...
      <div id="ban" style="">
    <h1  id="loginheading"style="color: white;"><b>Read Me</b></h1>
          ...
          $loginpassword=md5($loginpassword);
            ...
            else
            {
             ...
             // echo" <script>alert('Mobile Number or password is incorrect')</script>";
               echo "<script type='text/javascript'>login_erroralert()</script>";
            }   
         }
         ?>
    </form>
