   ...
   <div class="card">
    ...
    <div class="card-body card-block" >
      ...
      <form action="" method="POST">
        ...
        </div>                   <div class="col-md-6"><div class="form-group"><label for="vat" class=" form-control-label">Application Number</label><input type="text" name="app_no" id="vat"  class="form-control"></div>
      </div>
    </div>
...
// printf($select);
     ...
     {
      // $check_cunsumerno="SELECT * FROM gas_booking WHERE customer_id='$forin'";
      // $execute=mysqli_query($connect,$check_cunsumerno);
