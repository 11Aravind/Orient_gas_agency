...
// else if($house_complx=="")
// {
//   alert("enter house_complx");
//   return false;
// }
// else if($flat_no=="")
// {
...
$("#rationcardstatus").change(function(){
  if(($("#transaction_no").val()=="") || ($("#rationcardstatus").val()!="Antyodaya Anna Yojana") )
  {
